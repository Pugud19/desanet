                ...
                <div class="card-people mt-auto">
                  ...
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2">
                        <h4 class="location font-weight-normal">Garut</h4>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    ...
                    ?>
                    <div class="card-body">
                      <p class="mb-4">Total Pengguna Hari ini</p>
                      <p class="fs-30 mb-2"><?= $mb['total_pengguna'] ?></p>
                      <p>10.00% (30 days)</p>
                    </div>
                    <?php } ?>
                  </div>
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  ...
                  <?php 
                    ...
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?= $di['total_paket'] ?></p>
                      <p>masa aktif(30 days)</p>
                    </div>
                    <?php } ?>
                  </div>
                </div>
                    ...
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="font-weight-medium"><div class="badge badge-warning"><?= number_format($d['harga'],0,',','.') ?></div></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
